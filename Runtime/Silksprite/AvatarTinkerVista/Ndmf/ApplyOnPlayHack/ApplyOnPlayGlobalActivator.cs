...
namespace Silksprite.AvatarTinkerVista.Ndmf.ApplyOnPlayHack
{
    ...
    static class Av3EmuStatusChecker
    {
        ...
        { 
            if (!RuntimeConfig.ApplyOnPlay) return false;
    ...
    class ApplyOnPlayGlobalActivator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            if (!RuntimeConfig.ApplyOnPlay) return;
            ...
            foreach (var avatar in RuntimeUtilInternal.FindAvatarsInScene(gameObject.scene))
            {
